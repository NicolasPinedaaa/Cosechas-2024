...
#var.names.model.7  = c("ISE",  "tib", "spread", "crag", 'dm_Component')
...
if(0){
  ...
  grid.arrange(plot_lin(Vintage)[[31]],  plot_lin(Vintage)[[32]], plot_lin(Vintage)[[33]],
               ...
               layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(NA,5,5,NA)))
  h1 = hor+1
  Local.Proj.LFM2(obj.Addaemer=Vintage, data=data_mod1, h=h1,  plot.loc.proj.acum=TRUE, sin.CI=TRUE, EN=Elastic.Network)
 ...
 #                          layout_matrix=rbind(c(1,2,3,4),c(5,6,7,8),c(NA,9,10,NA)))
  ...
  for (i in seq_along(Coh.vars)) {
    ...
    c_irf <- ggplot(Coh.data_irf) +
      ...
      scale_x_continuous(limits = c(0,hor), breaks=seq(0,hor,3))+
      theme(axis.title = element_text(size = 9),axis.text = element_text(size = 6),
            plot.title = element_text(size = 12)) # was size=9
    #print(p_irf)
    IRFS[[i]] = c_irf
  }
  names(IRFS) = Coh.vars
...
if(0){
  ...
  for (i in seq_along(Per.vars)) {
    ...
    p_irf <- ggplot(Per.data_irf) +
      ...
      scale_x_continuous(limits = c(0,hor), breaks=seq(0,hor,3))+
      theme(axis.title = element_text(size = 17),axis.text = element_text(size = 6),
...
if(0){
  ...
  for (i in seq_along(Per.vars)) {
    ...
    p_irf <- ggplot(Per.data_irf) +
      ...
      geom_line(aes(x=H,y=mean),size=1.3) +
      geom_hline(yintercept=0) +
      labs(x='Months', y=" ", title=paste0('Panel ', letras[i]," ", var.names.plots[i])) +
      scale_x_continuous(limits = c(0,hor), breaks=seq(0,hor,3))+
      theme(axis.title = element_text(size = 9),axis.text = element_text(size = 6),
            plot.title = element_text(size = 12))
    #print(p_irf)
  ...
  names(IRFS) = Per.vars
  Per_plots7 = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], ncol=2,
                            layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4)))
  #Per_plots7 = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], 
  #                          IRFS[[6]],IRFS[[7]],
  #                          ncol=2, top=paste0('Impulse-Response on Period Component for model ',
  #                                             Model.number),
  #                          layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(5,5,6,6),c(NA,7,7,NA)))
  ...
  names(IRFS) = Coh.vars
  Coh_plots7 = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], nrow=2,  
                            layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4)))
  #  Coh_plots2 = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], IRFS[[6]],
  #                            IRFS[[7]], nrow=3,  top=paste0('Impulse-Response on Vintage Component for model ',
  #                                                           Model.number),
...
if(0){
  ...
  names(IRFS) = Per.vars
  Per_plots8 = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], nrow=3,
                            layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(NA,5,5,NA) ))
  #Per_plots7 = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], 
  #                          IRFS[[6]],IRFS[[7]],
  #                          ncol=2, top=paste0('Impulse-Response on Period Component for model ',
  ...
  names(IRFS) = Coh.vars
  Coh_plots8 = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], nrow=3,  
                            layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(NA,5,5,NA) ))
  #  Coh_plots2 = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], IRFS[[6]],
  #                            IRFS[[7]], nrow=3,  top=paste0('Impulse-Response on Vintage Component for model ',
  #                                                           Model.number),
...
#----FALTA:----#
# Revizar archivo EXCEL(Reviewers Comments.xlsx) para ver que responde LFM (en verde)
...
if(0){
  ...
  for (i in seq_along(Per.vars)) {
    ...
    p_irf <- ggplot(Per.data_irf) +
      ...
      geom_line(aes(x=H,y=mean),size=1.3) +
      geom_hline(yintercept=0) +
      labs(y='Percentage Points',x='Months', title=paste0('Panel ', letras[i]," ", var.names.plots1[i])) +
           scale_x_continuous(limits = c(0,hor), breaks=seq(0,hor,3)) +
           theme(axis.title = element_text(size = 14),axis.text = element_text(size = 6),
                 plot.title = element_text(size = 16))
    #print(p_irf)
    IRFS[[i]] = p_irf
  }
  names(IRFS) = Per.vars
  Per_plots = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], 
                  nrow=3, 
                  layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(NA,5,5,NA)))
  ggsave(paste0('PerIRF_Model',Model.number,'_',Elastic.Network,'.pdf'), plot=Per_plots, device = "pdf")
  ...
  names(IRFS) = Coh.vars
  Coh_plots = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], nrow=3, 
                  layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(NA,5,5,NA)))
  ggsave(paste0('CohIRF_Model',Model.number,'_',Elastic.Network,'.pdf'), plot=Coh_plots, device = "pdf")
}
...
if(0){
  ...
  names(IRFS) = Per.vars
  Per_plots = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], nrow=3, 
                           layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(NA,5,5,NA)))
  ggsave(paste0('PerIRF_Model',Model.number,'_',Elastic.Network,'.pdf'), plot=Per_plots, device = "pdf")
...
if(0){
  ...
  names(IRFS) = Per.vars
  Per_plots = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], IRFS[[6]], 
                            ncol=2,
                            layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(5,5,6,6)))
  #Per_plots = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], IRFS[[6]],
  #                          ncol=2, top=paste0('Impulse-Response on Period Component for model ',
  #                                             Model.number),
  #                          layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(5,5,6,6)))
  ggsave(paste0('PerIRF_Model',Model.number,'.pdf'), Per_plots, device = "pdf")
  #--------------  VAR con <Cohort> ---------------# 
  # Definicion del modelo
  Coh.VAR.lag     = 4
  cat("Rezago para Cohorte",Coh.VAR.lag, "\n")
  ...
  names(IRFS) = Coh.vars
  Coh_plots = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], IRFS[[6]], nrow=3,  
                            layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(5,5,6,6)))
  #  Coh_plots = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], IRFS[[6]],
  #                            IRFS[[7]], nrow=3,  top=paste0('Impulse-Response on Vintage Component for model ',
  #                                                           Model.number),
  #                           layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(5,5,6,6),c(NA,7,7,NA)))
  ggsave(paste0('CohIRF_Model',Model.number,'.pdf'), Coh_plots, device = "pdf")
}
...
if(0){
  ...
  Per_plots = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]],IRFS[[6]],
                            ncol=2,
                            layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(5,5,6,6)))
  #Per_plots2 = grid.arrange(IRFS[[1]], IRFS[[2]], IRFS[[3]], IRFS[[4]], IRFS[[5]], IRFS[[6]],
  #                          ncol=2, top=paste0('Impulse-Response on Period Component for model ',
  #                                             Model.number),
  #                          layout_matrix=rbind(c(1,1,2,2),c(3,3,4,4),c(5,5,6,6),c(NA,7,7,NA)))
  ggsave(paste0('PerIRF_Model',Model.number,'.pdf'), Per_plots, device = "pdf")
